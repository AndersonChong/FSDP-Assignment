...
class FeedbackRequest(BaseModel):
    chat_id: str  # unique ID for this conversation
    message_id: str  # unique ID for the bot response
    agent_id: str
...
class KnowledgeBaseUploadRequest(BaseModel):
    agent_id: str
    content: str  # document content (text extracted from PDF or raw text)
...
class AgentChainRequest(BaseModel):
    ...
    user_message: str
    pass_context: bool = True  # pass primary agent response to secondary agent
